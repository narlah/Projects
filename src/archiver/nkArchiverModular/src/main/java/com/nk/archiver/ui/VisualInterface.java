...
public class VisualInterface {
  ...
  public Shell initUI() {
    ...
    if (controller.getCompressorName() != null && controller.getCompressorName()
        .equalsIgnoreCase("Huffman")) {
      ctabFCodesItem = new CTabHuffmanCodesTabItem(tabFolder, SWT.NONE);
    }

    showCompressorWikiTabItem = new ShowCompressorWikiTabItem(tabFolder,
        controller.getCompressorName());
    ...
    class Open implements SelectionListener {
      ...
      public void widgetSelected(SelectionEvent event) {
        ...
        if (selected != null) {
          ...
          String outFileNameOnly = outFileName
              .substring(outFileName.lastIndexOf(File.separator) + 1);
    ...
    comboCompressSelector
        .setItems(Arrays.toString(compressionTypes.values()).replaceAll("^.|.$", "").split(", "));
