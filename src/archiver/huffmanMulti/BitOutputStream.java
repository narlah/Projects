...
public class BitOutputStream extends OutputStream {
     ...
     * @throws IOException If an underlying IOException occurs while writing to the
     *                     stream
     */
    ...
    public void write(int value) throws IOException {
        if (currentBits == 0)
            ...
            /*
             * // Write the top part final int bitsWritten = 8 - currentBits;
			 * currentByte <<= bitsWritten; currentByte |= (value >> (8 -
			 * bitsWritten)) & ((2 << bitsWritten) - 1);
			 * outputStream.write(currentByte);
			 * 
			 * // Write the bottom part final int bitsRemaining = 8 -
			 * bitsWritten; final int bitOffset = bitsRemaining % 8; currentByte
			 * = value & ((2 << bitOffset) - 1); currentBits = bitOffset;
			 */
        }
    }
