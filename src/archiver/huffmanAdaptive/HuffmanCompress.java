...
public final class HuffmanCompress {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // The resulting generated code is optimal for static Huffman coding and
        // also canonical
        ...
        code = canonCode.toCodeTree(); // Replace code tree with canonical one.
        // For each symbol, the code value may
        // change but the code length stays the
        // same.

        // Read input file again, compress with Huffman coding, and write output
        // file
    ...
    static void writeCode(BitOutputStream out, CanonicalCode canonCode) throws IOException {
        for (int i = 0; i < canonCode.getSymbolLimit(); i++) {
            ...
            if (val >= 256) throw new RuntimeException("The code for a symbol is too long");
