...
public final class BitInputStream {
    ...
    // Either in the range 0x00 to 0xFF if bits are available, or is -1 if the
    ...
    // Reads a bit from the stream. Returns 0 or 1 if a bit is available, or
    // throws an EOFException if the end of stream is reached.
