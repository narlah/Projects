...
public final class HuffmanDecoder {
    ...
    // The code tree can be changed after each symbol decoded, as long as the
    // encoder and decoder have the same code tree at the same time.
    ...
    public int read() throws IOException {
        ...
        while (true) {
            ...
            if (nextNode instanceof Leaf) return ((Leaf) nextNode).symbol;
            else if (nextNode instanceof InternalNode) currentNode = (InternalNode) nextNode;
            else
                throw new AssertionError();
        }
    }
